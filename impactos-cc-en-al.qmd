...
plot_raster <- function(df, value_col, title, subtitle, legend_title, outfile_png, aoi_sf) 
  {
    ...
    if(grepl("temp", title)) paleta <- "C" else paleta <- "G"
...
physical exposure to climate change, has a global ecological importance.
The human population in the region has economic dependence on
climate-sensitive sectors, and social inequality provoke a state of
...
effects can be summarized as ilustrated in @tbl-efectos. Expectations are that these effects will keep increasing. 
...
: Some effects of climate change in Latin America that  have been
already detected {#tbl-efectos}
...
g2 <- plot_raster(
  ...
  title = "Annual precipitation (mm) - baseline",
  subtitle = "WorldClim v2.1 1970–2000",
  legend_title = "mm/año",
...
g1 | mapas[["245"]][[1]] / mapas[["585"]][[1]] + plot_layout(guides = 'collect')
g2 | mapas[["245"]][[2]] / mapas[["585"]][[2]] + plot_layout(guides = 'collect')
