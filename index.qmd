...
plot_raster <- function(df, value_col, title, subtitle, legend_title, outfile_png, aoi_sf) 
  {
    ...
    resxy <- attr(df, "resxy")
      ...
      } else paleta <- list("mako", 0.35, 0.75)
...
We are framing Latin America’s vulnerability to climate change using the **IUCN’s ecosystem typology** for climate action. In particular, IUCN has developed the *Ecosystem Red List & Key Biodiversity Areas (KBA)*, which are tools that help the identification of ecosystems at risk of collapse and areas of high conservation value. This assessment has gathered evidedne hr support the view that in Latin America an the Caribbean region particular attention should be directed to Amazon, mangroves, páramos, tropical dry forests and coral reefs. A concensus perspective is emerging suggesting that strong comitments are required to protect–restore–manage habitats, reduce direct climate hazards, and address indirect human–climate synergies (@tbl-drivers).  
